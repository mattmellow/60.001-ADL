import sys, os
import optparse  # Change this line at the top of the file
import torch
...
def train(dir_path, num_epochs, test_model, batch_size, lr, weight_decay):
    ...
    min_loss = min_val_loss # Track minimum validation loss
    ...
    # Run test set evaluation if requested
    if test_model:
